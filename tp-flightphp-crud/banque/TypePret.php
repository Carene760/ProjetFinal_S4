...
=======
    const apiBase = "http://localhost/Bemaso_Projet/tp-flightphp-crud/ws";
>>>>>>> Stashed changes
...
=======
              <button onclick='remplirFormulaire(${JSON.stringify(e)})' class="btn btn-sm btn-warning action-btn" title="Modifier">
                <i class="fas fa-edit"></i>
              </button>
              <button onclick='supprimerTypePret(${e.id})' class="btn btn-sm btn-danger action-btn ms-2" title="Supprimer">
...
=======
      // Validation simple
      if (!nom || !taux_interet || !duree_max || !montant_min || !montant_max) {
      ...
      if (id) {
        showMessage("Modification du type de prêt...", "success-message");
>>>>>>> Stashed changes
...
=======
      if (confirm("Voulez-vous vraiment supprimer ce type de prêt ? Cette action est irréversible.")) {
        showMessage("Suppression en cours...", "success-message");
>>>>>>> Stashed changes
